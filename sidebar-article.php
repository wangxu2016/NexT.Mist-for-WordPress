        ...
        <section class="site-overview sidebar-panel">
            <div class="site-author motion-element" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
                <img class="site-author-image" itemprop="image"
                     src="<?php echo stripslashes(get_option('my_avatar')); ?>"
                     alt="<?php echo stripslashes(get_option('my_author_name')); ?>">
                <p class="site-author-name"
                   itemprop="name"><?php echo stripslashes(get_option('my_author_name')); ?></p>
                <p class="site-description motion-element" itemprop="description"
                ><?php echo stripslashes(get_option('my_description')); ?></p>
            </div>
